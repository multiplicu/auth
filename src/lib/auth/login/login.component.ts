...
export class LoginComponent implements OnDestroy {
	...
	@Input() public title = 'Sign in to Multipli Credit Union';
	@Output() public loginSuccess: EventEmitter<AuthUser> = new EventEmitter();
	@Output() public loginError: EventEmitter<HttpErrorResponse> = new EventEmitter();

	public loginForm: FormGroup;

	private subs_: Subscription[] = [];

	public constructor(public authService: AuthService, private fb_: FormBuilder) {
